...
public class FakeSearchResponse {
    ...
    public static SearchResponse oneFile() {
        ...
        searchResponse.setFiles(Arrays.asList(new SearchEntry("fileId", new Date(), "type", "A wonderful file (title)", "downloadUrl",
                "thmbnailUrl", "Dropbox", "Storage", "first Job", "...lore ipsum...", new HashMap<String, String>())));
